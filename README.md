...
```dotenv
RELAY_UPDATE_COMMAND=git -C /host-project pull --ff-only https://github.com/zhaozihao1/qingqiuzhuanfa.git main && docker compose -f /host-project/docker-compose.yml up -d --build
```
